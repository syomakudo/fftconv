...
# from models import CNNEx,CNN_LayerModel, FFT_LayerModel
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kernel_l1', type=int, default=129) #default=65,  80, 65
    parser.add_argument('--kernel_l2', type=int, default=65) #default=33
    parser.add_argument('--kernel_l3', type=int, default=33) #default=17
    parser.add_argument('--o_channels_l1', type=int, default=4) #default=20
    parser.add_argument('--o_channels_l2', type=int, default=4) #default=50
    parser.add_argument('--o_channels_l3', type=int, default=4) #default=50
    parser.add_argument('--learnnum_t', type=int, default=1000)
    parser.add_argument('--learnnum_v', type=int, default=200)
    ...
    parser.add_argument('--comment', type=str, default='') #32
