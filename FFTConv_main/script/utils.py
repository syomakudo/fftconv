...
def save(log_dir,prefix,state_dict, is_best):
    checkpoint_path = os.path.join(log_dir, '{}_checkpoint.pt'.format(prefix))
    torch.save(state_dict, checkpoint_path)
    if is_best:
        best_model_path = os.path.join(log_dir, '{}_best_model.pt'.format(prefix))
